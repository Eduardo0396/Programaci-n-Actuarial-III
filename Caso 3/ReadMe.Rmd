...
Con la última base de datos `data` lo convertiremos en un libro de texto que aparecerá en el directorio de trabajo.
...
```
Opuparemos la función `write.table` para hacer el libro de texto con la base de datos.
```r
